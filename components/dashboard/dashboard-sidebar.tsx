...
import { File, FileText, LayoutDashboard, Settings, User, Users, Building } from "lucide-react"
        ...
        <div className="border-t p-4">
          <div className="flex items-center gap-3 md:gap-2">
            ...
            <div className="space-y-0.5">
              ...
              {user?.departmentName && <p className="text-xs text-gray-500">{user.departmentName}</p>}
            </div>
          </div>
        </div>
      </div>
